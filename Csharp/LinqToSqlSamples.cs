...
namespace SampleQueries {
    ...
    public class LinqToSqlSamples : SampleHarness {
        ...
        //private readonly static string dbPath = Path.GetFullPath(Path.Combine(Application.StartupPath, @"d:\Data\NORTHWND.MDF"));
        //private readonly static string sqlServerInstance = @"(localdb)\project2016";
        public static string ConnString = QuerySamples.Properties.Settings.Default.NorthwindConnection;
